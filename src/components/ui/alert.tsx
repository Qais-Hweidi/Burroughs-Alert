  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        info:
          "border-blue-500/50 text-blue-800 bg-blue-50 dark:bg-blue-950 dark:text-blue-400 [&>svg]:text-blue-600",
      },
    },
    defaultVariants: {
      variant: "default",
...
export interface AlertWithIconProps extends React.HTMLAttributes<HTMLDivElement> {
  title?: string
  description?: string
  dismissible?: boolean
  onDismiss?: () => void
